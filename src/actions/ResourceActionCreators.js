...
let AppActionConstants = require('../constants/AppActionConstants');
let ResourceApi = require('../utils/ResourceApi');

let ResourceActions = function (resource) {
...
ResourceActions.prototype._buildEventName = function () {
	let operation = this.resourceOperation.toUpperCase();
